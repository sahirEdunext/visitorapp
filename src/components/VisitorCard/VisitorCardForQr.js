    ...
    return (
        <div className="card cus_vis_box">
                    ...
                    <div className="card-block">
                        ...
                        <div className="description mb-2">
                            <div className="w-col-6">
                                <div><span className="V-key"> Check In :</span>
                                    <span className="V-value"><span className="date">{props.data.intime ? props.data.intime : 'Not Checked In'}</span></span></div>
                                ...
                                <div><span className="V-key">Visitor Type :</span><span className="V-value text-capitalize">{props.data.visit_type == 'visitor' ? 'Walk-In' : props.data.type}</span></div>
                            </div>
                            <div className="w-col-6">
                                <div><span className="V-key"> Check Out :</span>
                                    <span className="V-value"><span className="date">{props.data.outtime ? props.data.outtime : 'Not Checked Out'}</span></span></div>
            ...
            <div className="card-footer text-muted p-0 mt-2">
                ...
                {!props.data.outtime && props.data.intime && <Button className="CheckOut-btn" onClick={() => props.checkout(props.data.id, props.data.type)}>Check Out</Button>}
...
export default withRouter(VisitorCardForQr);