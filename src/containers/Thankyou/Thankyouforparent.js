...
const Thankyouforparent = (props) =>  { 
    ...
    var newQRValue=0;
    if(props.location.state.data.parentvisitorid !== undefined) {
        newQRValue = props.location.state.data.parentvisitorid
    }
        ...
        <Container fluid className="Edu-container Thank-container">
            <Row>
                ...
                <Col sm={6} className='right-col'>
                    {props.location.state.nameForThankyou.visitorTypeName == "WalkIn" ? 
                    <div className="Box-right align-items-center d-flex flex-column justify-content-center">
                        <div id="cardContainer" className="Qr-container qr-box-border cardBoxQr">
                            ...
                            <div className="mt-3">
                                <img className="thankParImage" src={props.location.state.nameForThankyou.visitorPhotoForId ? props.location.state.nameForThankyou.visitorPhotoForId : selectedParIcon} alt="" />
                                <p className="tcapitalize mt-1 font-weight-bold">{props.location.state.nameForThankyou.visitorName}</p>
                            </div>
                            ...
                            <table className="Qr-data-table mb-0">
                                ...
                                <tr>
                                    ...
                                    <td className="tcapitalize wid80lg"> {props.location.state.nameForThankyou.purposeName}</td>
                                </tr>
                                <tr>
                                    <td className="cardTdL">Meeting To:</td>
                                    <td className="tcapitalize wid80lg"> {props.location.state.nameForThankyou.meetingToName}</td>
                                </tr>
                                </tbody>
                            </table>
                            </div>
                    ...
                    <div className="Box-right align-items-center d-flex flex-column justify-content-center">
                        <div>
                            ...
                            <p className="apntPara">We've received your request for Appointment. <br /> You shall be notified shortly. <br /><br /></p>{console.log(props.location.state.data)}
                            <p className="apntPara">Your Request No: <span className="appIdVisitor">EDU-{props.location.state.data.parentvisitorid ? props.location.state.data.parentvisitorid : props.location.state.data.appointmentid}</span></p>
                        </div>
                    </div>}
                </Col>
                <Footer/>
...
export default Thankyouforparent;
